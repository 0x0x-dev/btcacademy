...
def extract_currency_and_halal_status(title, content):
    ...
    if currency:
        if "ولم تجد خدمات حرام" in content or "ولم تجد خدمات مشبوهة" in content or "ولم تجد خمات مشبوهة" in content or "وننصح بالاستثمار بها" in content or f"فإن عملة {currency} حلال" in content or "والله أعلم" in content:
            is_halal = True
